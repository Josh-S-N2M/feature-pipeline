...
version: 1.1.0
supersedes: acceptance-tests.md (v1.0.0)
status: approved
...
generated: 2026-05-21T21:14:00Z
generated_by: claude (acting as test-acceptance-author re-invoked by finalize-reconciler cycle 2, continuation session)
authored_in_parallel_with: phase-validators-v1.1.0.md
supersession_addresses:
  - I-CA-004 (MAJOR — stage-number discipline violations, acceptance-tests portion: 1 instance at AT-027 heading)
---
...
- **Steps:**
  ...
  2. Read the current Plan version's OI-4 entry — must contain Plan-stage disposition (current: deferred). Confirm present.
...
### AT-027 — FR-11-a: Retroactive Deliverable Packaging memo (CONDITIONAL)
...
- **Steps:**
  ...
  2. **Else** confirm the current Plan version's OI-5 records the non-execution (deferral remains).
...
| 1.1.0 | 2026-05-21T21:14:00Z | claude (continuation session, acting as test-acceptance-author re-invoked by finalize-reconciler cycle 2) | Supersedes v1.0.0 per ADR-0005. Addresses cross-artifact audit round 2 finding I-CA-004 (MAJOR — stage-number discipline violation class, acceptance-tests portion: AT-027 heading rewritten from "Retroactive Stage 13 memo" to "Retroactive Deliverable Packaging memo"). Also addresses 2 stale `plan-v1.md` body references discovered during cycle-2 pre-round-3-audit sanity sweep — these were derivative defects from the supersession of plan-v1.md → plan-v1.2.0.md (line 334 AT-026 step 2 "Read `plan-v1.md` OI-4 (line 409)" → "Read the current Plan version's OI-4 entry"; line 344 AT-027 step 2 "confirm `plan-v1.md` OI-5" → "confirm the current Plan version's OI-5"). Version-agnostic form chosen to prevent recurrence on any future Plan supersession. No other content changes; the 32 ATs and coverage matrix remain unchanged. See `reconciliation-log-cycle2.md` and `cross-artifact-audit-issues-r2.json` for full audit trail. |
