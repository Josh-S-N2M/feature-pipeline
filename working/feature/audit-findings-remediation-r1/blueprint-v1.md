...
generated: 2026-05-21T18:50:00Z
generated_by: claude (acting as design-composer)
approved_at: 2026-05-21T19:00:00Z
gate_passed: 4
adrs_authored:
...
superseded_by: blueprint-v1.1.0.md
---
...
- **FR-11 P3 (Stage 13 retroactive)**: AC-FR-11-a (optional memo if executed)
...
**Deferred to Stage 9 (Plan Authoring)** per ADR-0023 (plan-author owns task ordering). The dependency graph in `cc-dependencies.json` is the Plan's input; sequencing within the dependency graph constraints is the plan-author's call per user constraint 4.
