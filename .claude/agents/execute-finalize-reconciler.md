...
- `adrs/ADR-0034-prd-mis-credit-cleanup.md` — symmetric application of ADR-0017 to per-task + phase cycle counters per D-12
...
6. **Dispatch via Agent** — invoke the target subagent with the revision_context payload.
...
## Cycle-cap escalation (D-12 + ADR-0034)
...
- You do NOT modify code or artifacts directly. You dispatch.
...
6. Dispatch via Agent tool with revision_context.
