...
const LENSES = [
  ...
  { key: 'arch-plan-linkage', prompt: `Read ${ARCH} and ${PLAN}. Check bidirectional linkage: every architectural decision (Dn / D-DOM / D-KN / D-TB) has a plan workstream home; every plan workstream traces to a decision; every plan deliverable names the existing code it changes. List dangling links in both directions.` },
