...
- [ ] **Q3 (ADR-0024 drift)**: Does this feature reconcile the confirmed drift between [adrs/ADR-0024-*.md](../../adrs/) and [adrs/ADR-0024-frontend-design-knowledge-corpus-structure.md](../../adrs/ADR-0024-frontend-design-knowledge-corpus-structure.md) by picking a canonical body, or flag-and-defer? Reconciliation requires semantic judgment about which body is project-canonical. Recommendation lean: flag and defer; reconciliation is a separate decision.
