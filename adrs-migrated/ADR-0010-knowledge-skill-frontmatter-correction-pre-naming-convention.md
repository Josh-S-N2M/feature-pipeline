...
- `documentation-criteria` skill (per ADR-0011, canonical document skill): documents this convention so future skill authors follow it.
...
- [ ] Document the convention in `documentation-criteria` (per ADR-0011).
...
- ADR-0011: documentation-criteria — documents the convention for future skill authors.
