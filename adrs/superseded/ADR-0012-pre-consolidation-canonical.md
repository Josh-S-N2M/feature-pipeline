...
---
**Provenance footer (added by T2d.2):** Archived from canonical `adrs/ADR-0012-prd-stage.md` during adr-placement-mechanism-repair-r1 Phase 2d (sub-procedure ii — archive-wins consolidation per ADR-0055 v1.0.1). The archive version from `adrs-migrated/ADR-0012-prd-stage.md` is the new canonical. See git log for full provenance.
